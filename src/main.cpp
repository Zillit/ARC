...
{
	cout << SpiOpenPort(0) << endl;
	// SpiOpenPort (1);
	// unsigned char* text=new unsigned char[1024]();
	unsigned char text_string[]="this might work";
	unsigned char * text=&text_string[0];
	cout << "test" << endl;
	...
	// {
		// for(int i=0;i<8;i++)
		// {
			SpiWriteAndRead (0, text, sizeof(text));
		// }
	// }
	// cin >> text;
	//SpiWriteAndRead (0, text, sizeof(text));
